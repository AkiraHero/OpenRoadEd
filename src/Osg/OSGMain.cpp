...
*/
void OSGMain::initViewer(int x, int y, int width, int height, XID window)
{
	...
	// set up the camera manipulators.
	{
		...
		keyswitchManipulator->addMatrixManipulator( '6', "Own2", dynamic_cast<osgGA::CameraManipulator*>(new OSGCameraControls2()));
...
*/
void OSGMain::createContext(int x, int y, int width, int height, XID window)
{
